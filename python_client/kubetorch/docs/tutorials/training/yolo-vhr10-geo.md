# YOLOv8 Object Detection with VHR-10
```{admonition} Adapted
...
Requires: `GPU`. [View source](https://github.com/cezarc1/kubetorch/blob/main/examples/tutorials/geo/vhr10/yolo_vhr10/yolov8_vhr10_training.py).
```
