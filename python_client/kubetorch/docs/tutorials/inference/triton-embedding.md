# Online Embedding Inference with Triton
```{admonition} Adapted
...
Requires: `GPU`, `Triton`. [View source](https://github.com/cezarc1/kubetorch/blob/main/examples/tutorials/triton/embedding.py).
```
```python
