# Distributed DLRM Training with Ray
...
Requires: `Ray`, `Multi-node GPU`. [View source](https://github.com/cezarc1/kubetorch/blob/main/examples/tutorials/ray/dlrm-movielens/dlrm_training.py).
```
