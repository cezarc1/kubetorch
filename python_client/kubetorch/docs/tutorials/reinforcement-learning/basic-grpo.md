# Illustrative GRPO Training with Kubetorch
```{admonition} Adapted
...
Requires: `Multi-GPU`. [View source](https://github.com/cezarc1/kubetorch/blob/main/examples/tutorials/reinforcement_learning/basic_grpo/gsm8k.py).
```
