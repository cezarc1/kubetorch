# PyTorch Training with Preemption Recovery
```{admonition} Adapted
...
Requires: `Multi-node GPU`. [View source](https://github.com/cezarc1/kubetorch/blob/main/examples/tutorials/fault_tolerance/preemption_recovery.py).
```
