# Kubeflow Trainer and Kubetorch
...
Requires: `GPU`, `Kubeflow Trainer`. [View source](https://github.com/cezarc1/kubetorch/blob/main/examples/tutorials/geo/vhr10/dinov3_vhr10/using_kubeflow_trainer_classifier.py).
```
