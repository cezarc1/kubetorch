...
Requires: `GPU`, `Temporal`. [View source](https://github.com/cezarc1/kubetorch/blob/main/examples/tutorials/temporal/xgboost_training/trainer.py).
```
