...
def validate_service_no_in_kt_list(service_name: str):
...
def validate_teardown_output(
    ...
    prefix: str = None,
    resources_with_cached_data: bool = False,
):
    ...
    if resources_with_cached_data:
        assert f"✓ Deleted cached data for {service_name}" in teardown_output

    validate_service_no_in_kt_list(service_name=service_name)
